...
(function () {
    ...
    window.RsLiquideffectAddOn = function (_$, slider) {
        ...
        $ = _$;
        $.event.special.rsLiquidEffectDestroyed = {
            remove: function (evt) {
                evt.handler();
            }
        };
        ...
        var effects = slider.find('li[data-liquideffect]').each(function () {
            ...
            if (!sprite) {
                ...
                sprite = $this.find('.slotholder').contents().filter(function () {
            ...
            if (sprite) {
                ...
                }).removeAttr('data-kenburns').data({
                    liquideffectsettings: settings,
                    liquideffectorig: jQuery.extend({}, settings)
                });
    ...
    LiquidEffect.prototype = {
        ...
        destroy: function () {
            ...
            if (this.effects) this.effects.each(function () {
                jQuery(this).removeData('liquideffectcanvas liquideffectsettings liquideffectorig');
            });
    ...
    LiquidCanvas.prototype = {
        ...
        transitionIn: function () {
            ...
            punchgs.TweenLite.to(this.renderer.view, transTime * 0.5, {
                opacity: 1,
                ease: this.settings.easing,
                overwrite: 'all',
                delay: this.del
        ...
        animateOut: function (nextslide) {
            ...
            punchgs.TweenLite.to(this.renderer.view, transTime, {
                opacity: 0,
                ease: this.settings.easing,
                delay: transTime * 0.5
            });
