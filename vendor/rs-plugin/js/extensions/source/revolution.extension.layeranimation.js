...
///////////////////////////////////////////
    jQuery.extend(true, _R, {
                ...
                if (d.frames !== undefined) {
                    for (var i = 0; i < d.frames.length; i++) {
                        ...
                        if (d.frames[i].frame === "hover")
                            d.hoverframeindex = i;
                        else if (d.frames[i].frame === "frame_999" || d.frames[i].frame === "frame_out" || d.frames[i].frame === "last" || d.frames[i].frame === "end")
                            d.outframeindex = i;
        ...
        animateTheCaptions: function (obj) {
            ...
            if (index !== undefined && opt.layers[index])
                jQuery.each(opt.layers[index], function (i, a) {
                    ...
                    if (!preset || startSlideAnimAt === 0) _R.buildFullTimeLine({
                        caption: _t,
                        opt: opt,
                        offsetx: base_offsetx,
                        offsety: base_offsety,
        ...
        prepareSingleCaption: function (obj) {
            ...
            else if (_._nctype !== "row")
                punchgs.TweenLite.set(_._pw, {
                    zIndex: tpcapindex,
                    width: _.columnwidth,
                    top: 0,
                    left: 0,
        ...
        buildFullTimeLine: function (obj) {
                    ...
                    _nc.hover(function (e) {
                            ...
                            if (animended) {
                                ...
                                if (_.hoverzIndex || (_.hoveranim.anim && _.hoveranim.anim.zIndex)) {
                                    ...
                                    _.hovertimelines.pwhoveranim = punchgs.TweenLite.to(_._pw, frame.speed / 1000, {
                                        overwrite: "auto",
                                        zIndex: _.hoverzIndex
                                    });
                        ...
                        function (e) {
                            ...
                            if (animended) {
                                ...
                                if (_.hovertimelines.pwhoveranim !== undefined) _.hovertimelines.pwhoveranim = punchgs.TweenLite.to(_._pw, frame.speed / 1000, {
                                    overwrite: "auto",
                                    zIndex: _.basiczindex
                                });
            ...
            for (var frame_index = 0; frame_index < _.frames.length; frame_index++) {
                ...
                if (frame_index !== _.hoverframeindex) {
                    ...
                    _nc_timeline = _R.createFrameOnTimeline({
                        caption: obj.caption,
                        timeline: _nc_timeline,
                        label: frame_name,
        ...
        createFrameOnTimeline: function (obj) {
            ...
            if (_.splittext && frame_index === 0) {
                ...
                _.mySplitText = new punchgs.SplitText(splittarget, {
            ...
            if ((frame_index === 0 && !obj.fromcurrentstate && _._bmask !== undefined && $sfx !== undefined && $sfx.indexOf("block") >= 0) ||
                ...
                var $sfx_speed = frame_index === 0 ? ($from.speed / 1000) / 2 : ($to.speed / 1000) / 2,
                    $sfx_ft = [{scaleY: 1, scaleX: 0, transformOrigin: "0% 50%"}, {
                        scaleY: 1,
                        scaleX: 1,
                        ease: $to.anim.ease
                    }],
                ...
                switch ($sfx) {
                    ...
                    case "blockfromtop":
                    case "blocktobottom":
                        $sfx_ft = [{scaleX: 1, scaleY: 0, transformOrigin: "50% 0%"}, {
                            scaleX: 1,
                            scaleY: 1,
                            ease: $to.anim.ease
                        }];
                    ...
                    case "blockfrombottom":
                        $sfx_ft = [{scaleX: 1, scaleY: 0, transformOrigin: "50% 100%"}, {
                            scaleX: 1,
                            scaleY: 1,
                            ease: $to.anim.ease
                        }];
            ...
            if (frame_index === 0 && !obj.fromcurrentstate) {
                if (_._sfx_in === "block")
                    timeline.add(tweens.content.staggerFromTo(animobject, 0.05, {x: 0, y: 0, autoAlpha: 0}, {
                        x: 0,
                        y: 0,
                        autoAlpha: 1,
                        delay: $sfx_blockdelay
                    }), label);
                else {
                ...
                if (_._sfx_out === "block" && frame_index === _.outframeindex) {
                    timeline.add(tweens.content.staggerTo(animobject, 0.001, {
                        autoAlpha: 0,
                        delay: $sfx_blockdelay
                    }), label);
                    timeline.add(tweens.content.staggerTo(animobject, ((($to.speed / 1000) / 2) - 0.001), {
                        x: 0,
                        delay: $sfx_blockdelay
                    }), label + "+=0.001");
            ...
            else if ($mask_to !== undefined && $mask_to !== false)
        ...
        endMoveCaption: function (obj) {
            ...
            else if (!nc.static || (obj.currentslide >= nc.removeonslide) || (obj.currentslide < nc.showonslide)) {
                nc.outnow = new punchgs.TimelineLite;
                nc.timeline.pause();
                if (_.visibleelement === true)
                    _R.createFrameOnTimeline({
                        caption: obj.caption,
                        timeline: nc.outnow,
                        label: "outnow",
                        frameindex: obj.caption.data("outframeindex"),
                        opt: obj.opt,
        ...
        playAnimationFrame: function (obj) {
            ...
            _.triggeredtimeline = _R.createFrameOnTimeline({
                caption: obj.caption,
                timeline: _.triggeredtimeline,
                label: "triggered",
                frameindex: frameindex,
                updateStaticTimeline: true,
                opt: obj.opt,
                ignorefirstframe: true,
                fromcurrentstate: fcs
            }).play();
    ...
    var tweenOnStart = function (frame_index, ncobj, pw, _, tl, toanim, _nc, ust, opt) {
        ...
        if (ncobj.dchildren !== "none" && ncobj.dchildren !== undefined && ncobj.dchildren.length > 0) {
            ...
            else if (frame_index === _.outframeindex)
                for (var q = 0; q < ncobj.dchildren.length; q++) {
    ...
    var callCaptionLoops = function (el, factor) {
        ...
        if (el.hasClass("rs-pendulum")) {
            if (_._loop_timeline == undefined) {
                ...
                _._loop_timeline.append(new punchgs.TweenLite.fromTo(el, speed, {
                    force3D: "auto",
                    rotation: startdeg,
        ...
        if (el.hasClass("rs-slideloop")) {
            if (_._loop_timeline == undefined) {
                ...
                _._loop_timeline.append(new punchgs.TweenLite.fromTo(el, speed, {force3D: "auto", x: xs, y: ys}, {
                    x: xe,
                    y: ye,
                    ease: easing
                }));
        ...
        if (el.hasClass("rs-wave")) {
            if (_._loop_timeline == undefined) {
                ...
                var _ox = ((parseInt(oo.x, 0) / 100) - 0.5) * el.width(),
                    ...
                    waveanim = new punchgs.TweenLite.fromTo(angobj, speed, {a: (0 + ang)}, {
                        a: (360 + ang),
                        force3D: "auto",
