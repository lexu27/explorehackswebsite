    ...
    jQuery.extend(true, _R, {
        ...
        createNavigation: function (container, opt) {
            ...
            var cp = container.parent(),
                _a = opt.navigation.arrows, _b = opt.navigation.bullets, _c = opt.navigation.thumbnails,
        ...
        if (fin)
            jQuery.each(fin, function (i, el) {
                if (o.direction === "vertical")
                    tws.add(punchgs.TweenLite.set(el, {
                        top: (i * (ch + parseInt((o.space === undefined ? 0 : o.space), 0))),
                        width: cw + "px",
                        height: ch + "px"
                    }));
                        ...
                        case "move":
                            ...
                            if (_.infinity === "off") {
                                ...
                                if ((_.overpull === "none" || _.overpull === 0) && (bb < 0 || bb > opt.slideamount - 1))
                                    _.overpull = distance;
                                else if (bb >= 0 && bb <= opt.slideamount - 1 && ((bb >= 0 && distance > _.overpull) || (bb <= opt.slideamount - 1 && distance < _.overpull)))
                                    _.overpull = 0;
...
// NAVIGATION HELPER FUNCTIONS
    ...
    var showHideNavElements = function (container, opt, dir, speed) {
        ...
        switch (dir) {
            case "show":
                punchgs.TweenLite.to(container, speed, {
                    autoAlpha: 1,
...
// PUT ELEMENTS VERTICAL / HORIZONTAL IN THE RIGHT POSITION
    var putVinPosition = function (el, o, opt) {
        ...
        var elh = el.outerHeight(true),
            ...
            a = o.v_align === "top" ? {
                top: "0px",
                y: Math.round(o.v_offset + by) + "px"
            } : o.v_align === "center" ? {
                top: "50%",
                y: Math.round(((0 - elh / 2) + o.v_offset)) + "px"
    ...
    var putHinPosition = function (el, o, opt) {
        ...
        var elh = el.outerHeight(true),
            ...
            a = o.h_align === "left" ? {
                left: "0px",
                x: Math.round(o.h_offset + bx) + "px"
            } : o.h_align === "center" ? {
                left: "50%",
                x: Math.round(((0 - elw / 2) + o.h_offset)) + "px"
    ...
    var setNavElPositions = function (el, o, opt) {
        ...
        if (el.hasClass("tp-thumbs") || el.hasClass("tp-tabs")) {
            ...
            if (o.span === true && o.direction === "vertical") {
                punchgs.TweenLite.set(el, {
                    maxHeight: (cpt + cpb + (wh - 2 * wpad)) + "px",
                    height: (cpt + cpb + (wh - 2 * wpad)) + "px",
                    top: (0 - cpt),
                    y: 0
                });
...
// ADD THUMBNAILS
    var addThumb = function (container, o, li, what, opt) {
        ...
        if (container.parent().find(thumbs).length === 0) {
            ...
            else if (o.position === "outer-bottom")
        ...
        t.css({
            maxWidth: (maxw) + "px",/*margin:_margin, */
            maxHeight: maxh + "px",
            overflow: "visible",
            position: position,
            background: o.wrapper_color,
