...
//////////////////////////////////////////
    ...
    var rotateHand = function (hand_inner, obj, _) {
        ...
        _.rotating_anim = punchgs.TweenLite.to(hand_inner, _.rotatespeed, {
            rotationZ: ro,
            ease: punchgs.Power3.easeOut,
            onComplete: function () {
                rotateHand(hand_inner, obj, _)
            }
        });
    }
    ...
    var jitterHand = function (hand_inner, obj, _) {
        ...
        if (_.jitter_direction == "horizontal") {
            ...
            _.jittering_anim = punchgs.TweenLite.to(hand_inner, _.jitterspeed, {
                x: _.lastwave,
                ease: punchgs.Power3.easeOut,
                onComplete: function () {
                    jitterHand(hand_inner, obj, _)
                }
            });
    ...
    var attachHandTo = function (opt, obj, wb) {
        ...
        punchgs.TweenLite.set(hand_image, {
            scaleX: wb.hand_scale,
            rotation: wb.hand_full_rotation,
            transformOrigin: wb.hand_origin,
            x: 0 - o.transform.transformX + wb.hand_x_offset,
            y: 0 - o.transform.transformY + wb.hand_y_offset
        });
            ...
            case "draw":
                ...
                if (_d.splittext != undefined && _d.splittext != "none") {
                        ...
                        tw.eventCallback("onStart", function (hand_inner, obj, wb) {
                            ...
                            if (el !== undefined && el.html() !== undefined && el.html().length > 0 && el.html().charCodeAt(0) != 9 && el.html().charCodeAt(0) != 10) {
                                ...
                                if (i < wb.tweens.length - 1)
                                    ...
                                    punchgs.TweenLite.to(hand_inner, speed, {
                                        x: x + w, onComplete: function () {
                                            wb.handEffect = "off";
                                            try {
                    ...
                    if (wb.hand_direction == "right_to_left") {
                        ...
                        punchgs.TweenLite.fromTo(hand_inner, s, {x: xf}, {
                            x: xt, ease: obj.layersettings.frames[0].ease, onComplete: function () {
                                wb.handEffect = "off";
                            }
                        });
                    } else if (wb.hand_direction == "top_to_bottom") {
                        var yf = offver,
                            yt = yf + disver;

                        punchgs.TweenLite.fromTo(hand_inner, s, {y: yf}, {
                            y: yt, ease: obj.layersettings.frames[0].ease, onComplete: function () {
                                wb.handEffect = "off";
                            }
                        });
                        wb.jitter_direction = "horizontal";
                    } else if (wb.hand_direction == "bottom_to_top") {
    ...
    var moveoutHand = function (opt, obj, wb) {
        ...
        punchgs.TweenLite.to(hand, sp, {
            top: tl.top, left: tl.left, autoAlpha: alp, x: pos.x, y: pos.y, ease: ea, onComplete: function () {
